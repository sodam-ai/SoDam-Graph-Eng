...
> `.PRD/` 추적 여부 — **형제 관례가 실제로 갈립니다**(2026-08-02 실측: 하네스 14개 추적 / 프롬프트 8개 추적 / 컨텍스트 0 / 리버스 0). **첫 커밋 전에 정하십시오** (추천: 추적함 — 설계 근거를 잃으면 안 됨).
...
1. **`SoDam-Agentic-Eng/docs/family-synergy.md`** — **정본** (6,210바이트, 소담에이전틱엔지니어링 소유)
...
- [ ] `.PRD` 를 git 추적할지 — **형제 관례가 2:2로 갈림**(하네스 14개·프롬프트 8개 추적 / 컨텍스트·리버스 0개). 추천: **추적함**
